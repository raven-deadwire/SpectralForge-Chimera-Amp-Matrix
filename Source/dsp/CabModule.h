...
private:double sampleRate{48000.0};bool enabled{true};float lowCutHz{70.f},highCutHz{9000.f};juce::dsp::IIR::Filter<float> hp,lp;juce::dsp::Convolution convolution;bool irLoaded{false};
};}
