...
private:
 ...
 struct LaneUI{juce::Label name;juce::ComboBox amp;juce::Slider level,bass,mid,treble,presence,resonance,cabLow,cabHigh,delay;juce::ToggleButton mute{"M"},solo{"S"},polarity{"Ø"},cab{"Cab"};std::unique_ptr<ComboA>ampA;std::array<std::unique_ptr<SliderA>,9> sliders;std::array<std::unique_ptr<ButtonA>,4> buttons;};
